...
(async () => {
  ...
  await page.locator('#compact-deck').selectOption(fixtures.a);
  ...
  assert.equal(await page.evaluate(()=>app.id),fixtures.a);
  assert.equal(await page.evaluate(()=>document.activeElement.id),'compact-deck');
  await page.locator('#delete-deck').click();
  ...
  assert.equal(times.focus,'compact-deck');
  ...
  await page.locator('#delete-deck').click();await page.locator('#delete-confirm').click();
