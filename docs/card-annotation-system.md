...
- **已完成**：规范与实现（分段、校验、覆盖清单、组合查询、自动草稿、个人层）、19 个当前 TAG 与 1 个兼容标签的词表；首批 11 张样本、第二批 35 张引擎审计清单、第三批 62 张手坑／解场、第四批 100 张完整系列及辅助卡、第五批 94 张烙印／死狱乡／自奏圣乐／青眼，以及第六批 100 张影灵衣／召唤兽／珠泪哀歌族／神碑／白森林／星杯系列缺口。第六批来源、异画与跳过原因见[逐卡清单](card-annotation-batch-2026-09-25-phase3.csv)；第五批见[1.47.5 清单](card-annotation-batch-2026-09-25-phase2.csv)。
- **进行中／未完成**：全卡库逐卡逐效果标注（当前 14,716 张非衍生物中，402 张已标注，14,314 张尚未标注），继续以完整系列分阶段核对；情报站等模块的效果级引用。样本之外的任何能力查询结果均受「已标注范围」限制，不宣称全库准确。
