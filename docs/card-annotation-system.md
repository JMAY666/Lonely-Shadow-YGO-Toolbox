...
- **已完成**：规范与实现（分段、校验、覆盖清单、组合查询、自动草稿、个人层）、19 个当前 TAG 与 1 个兼容标签的词表；首批 11 张样本、第二批 35 张引擎审计清单、第三批 62 张手坑／解场，以及 2026-09-25 按完整系列核对的 100 张新条目（杀手旋律 8、实战辅助 4、相剑 14、驱魔姐妹 18、转生炎兽 39、天威 17）。新增卡号、来源和旧条目复核结果见[本轮清单](card-annotation-batch-2026-09-25.csv)。
- **进行中／未完成**：全卡库逐卡逐效果标注（当前 14,716 张非衍生物中，208 张已标注，14,508 张尚未标注）；情报站等模块的效果级引用。样本之外的任何能力查询结果均受「已标注范围」限制，不宣称全库准确。
