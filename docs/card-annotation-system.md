...
- **已完成**：规范与实现（分段、校验、覆盖清单、组合查询、自动草稿、个人层）、19 个当前 TAG 与 1 个兼容标签的词表；首批 11 张样本、第二批 35 张引擎审计清单、第三批 62 张手坑／解场、第四批 100 张完整系列及辅助卡，以及第五批 94 张烙印／死狱乡／自奏圣乐／青眼系列缺口。第五批的逐卡来源与跳过原因见[本阶段清单](card-annotation-batch-2026-09-25-phase2.csv)，上一批见[1.47.4 清单](card-annotation-batch-2026-09-25.csv)。
- **进行中／未完成**：全卡库逐卡逐效果标注（当前 14,716 张非衍生物中，302 张已标注，14,414 张尚未标注），继续以完整系列分阶段核对；情报站等模块的效果级引用。样本之外的任何能力查询结果均受「已标注范围」限制，不宣称全库准确。
