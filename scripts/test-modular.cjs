...
const flags={core:null,implicit:'YGO_MODULAR_IMPLICIT_ONLY',preferences:'YGO_MODULAR_PREFERENCES_ONLY',routes:'YGO_MODULAR_ADDITIONAL_ONLY',cross:'YGO_MODULAR_CROSS_ONLY',mechanics:'YGO_MODULAR_MECHANICS_ONLY',rules:'YGO_MODULAR_RULES_ONLY',if:'YGO_MODULAR_IF_ONLY',precision:'YGO_MODULAR_PRECISION_ONLY',planning:'YGO_MODULAR_PLANNING_ONLY',pipeline:'YGO_MODULAR_PIPELINE_ONLY',forecast:'YGO_MODULAR_FORECAST_ONLY','second-hints':'YGO_MODULAR_SECOND_HINTS_ONLY','second-routes':'YGO_MODULAR_SECOND_ROUTES_ONLY','second-flow':'YGO_MODULAR_SECOND_FLOW_ONLY'};
