...
决斗依次经过「模式选择 → 功能选择 → 卡组选择 → 决定先/后攻 → 卡组展开」。功能选择沿用居中插画卡片；「手动选择」进入现有流程，「自动选择」保留为待开发入口。
...
1.19.0 新增决斗功能选择；1.19.1 进一步为游戏画面添加父窗口绘制隔离，防止外层界面重绘覆盖原生场地。详情见[1.19.1 验收记录](docs/verification-1.19.1.md)。
