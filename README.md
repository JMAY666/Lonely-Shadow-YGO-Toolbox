...
全部资料沿用本地 TAG 文件的原子保存、版本冲突检查和备份，卡库缺卡时保留编号和用户资料。使用方式、兼容与恢复见[情报站说明](docs/intelligence.md)，本次验证见[1.38.1 验证记录](docs/verification-1.38.1.md)，首版范围见[1.38.0 验证记录](docs/verification-1.38.0.md)。
