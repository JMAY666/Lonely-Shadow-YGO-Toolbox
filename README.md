...
1.23.0 新增自动起手预览与确认，操作边界见 [BO1 决斗说明](docs/duel.md)，检查结果见 [1.23.0 验收记录](docs/verification-1.23.0.md)。既有先后攻与卡组捕捉验证分别见 [1.22.0](docs/verification-1.22.0.md) 和 [1.21.0](docs/verification-1.21.0.md)。
