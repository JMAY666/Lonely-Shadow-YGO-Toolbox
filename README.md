...
现有青眼、转生炎兽、相剑、驱魔姐妹、杀手旋律五套系列徽记与七张联网核对的代表卡。系列名采用已核对的官方简体中文，仍可搜索「救祓少女」「杀手级调整曲」等旧译名；卡库原卡名、卡文、个人 TAG 与备注保留。其他系列从本地卡库生成普通卡牌夹和封面，尚未逐系列联网核对；徽记为项目设计的识别图形。可直接交给其他智能体继续扩充的[系列标识制作流程](docs/card-series-production-guide.md)包含来源、命名、封面、样例和校验步骤。
