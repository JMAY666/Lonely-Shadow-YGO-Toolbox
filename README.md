...
## 当前版本 · 1.47.4（按完整系列补充卡片效果标注）

按本地整数卡号补充 100 张已核对完整分段的卡牌：杀手旋律／杀手级调整曲 8、原清单辅助卡 4、相剑 14、驱魔姐妹 18、转生炎兽 39、天威 17。各系列旧条目 19 张对照当前卡文与官方 OCG 卡页／FAQ 后保留，五个系列在当前卡库中的成员均已覆盖。实际新增卡号、卡名、系列和来源见[本轮清单](docs/card-annotation-batch-2026-09-25.csv)；官方原始页面快照及检查证据只保留在本机 `.local/anno-batch4-research/`。当前非衍生物可标注范围 14,716 张，内置已核对 208 张，仍有 14,508 张未标注；未标注不代表没有相应能力。
...
联网对照 KONAMI 官方卡文与补充说明，复核首批 11 张参考样本后补全引擎审计清单 35 张、手坑／解场常用卡 62 张；本轮再按完整系列和实战辅助缺口补充 100 张。卡文变化后显示保存的旧卡文，停止用旧标注匹配当前能力；自动草稿不能一键确认为完整标注。覆盖统计排除衍生物：当前基础库 14,981 张，可标注 14,716 张，已标注 208 张，未标注 14,508 张。未标注不代表没有能力，脚本映射也不等于完整规则验证。
