...
后续第 2—5 点已整理为[实战辅助完善计划](docs/going-second-live-plan.md)：首个客户端选择 YGOPro，依次讨论对方意图、威胁优先级、响应时机与我方回合突破。该文档仍为计划，未启用相应功能，应用版本保持 1.42.2。
