...
> **BO1 保留手动教程，并可将已录入起手接入模块化的真实引擎验证与 AI 执行。** BO3、自动识别、自动决定先后攻和后攻突破尚未实现。详见 [BO1 决斗说明](docs/duel.md)。
...
本次检查与已知边界见[1.16 验收记录](docs/modular-verification-1.16.md)。完整操作说明保留在[使用与开发手册](docs/usage-guide.md)。
