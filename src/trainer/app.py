    ...
    def dispatch(self, post=False):
        try:
            ...
            if post:
                ...
                for name in ('duel.js', 'duel-smart.js', 'duel-second.js', 'duel-second-hints.js', 'duel-second.css', 'duel-automatic.js', 'duel-order.js', 'duel-opening.js', 'duel-automatic.css', 'duel-forecast.js', 'duel-model.js', 'tutorial-bindings.js', 'duel.css', 'deck-tag-view.js', 'deck-appearance.js', 'superpre.js', 'superpre.css'):
                    files['/' + name] = name
                if path in files:
