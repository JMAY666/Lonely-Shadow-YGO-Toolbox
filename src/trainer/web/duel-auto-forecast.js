...
function autoPaintForecastResults() {
  ...
  $('#auto-duel-brain-search').textContent=f.busy?'正在生成…':'重新生成路线';
  ...
  $('#auto-duel-brain-routes').innerHTML=coverage+forecastCandidatesHtml(f,preferenceLabel,'data-auto-duel-adopt');
  bindForecastCandidateDetails($('#auto-duel-brain-routes'),f);
