...
function unsavedSummary() {
  ...
  if (typeof knowledgeUnsavedSummary==='function'&&knowledgeUnsavedSummary()) messages.push(knowledgeUnsavedSummary());
...
async function editDesignDeck(target) {
  ...
  const keys=['deck','representatives','deckTags','deckTagNames','id','revision','sourceName','undo','savedState','selected'];
